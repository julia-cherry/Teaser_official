...
def process_image(image_file, output_file, vis_file, face_detector):
    ...
    image_rgb_tensor = torch.tensor(image_rgb)
    detection_result = face_detector(image_rgb_tensor)
    ...
    landmarks = detection_result[2][0].reshape(1,203,2).sequeze(0)
...
def process_sample(args):
    ...
    face_detector = convert('datasets/preprocess_scripts/landmark.onnx')
